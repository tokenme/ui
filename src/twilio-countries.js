export const countries = [
  ...
  { name: 'Ascension', code: 247, iso: 'AC' },
  { name: 'Australia/Cocos/Christmas Island', code: 61, iso: 'AU' },
  ...
  { name: 'Dominican Republic', code: 1809201, iso: 'DO' },
  ...
  { name: 'Finland/Aland Islands', code: 358, iso: 'FI' },
  ...
  { name: 'Hong Kong', code: 852, iso: 'HK', lang: 'zh_TW' },
  ...
  { name: 'Korea Dem People\'s Rep', code: 850, iso: 'KP' },
  { name: 'Korea Republic of', code: 82, iso: 'KR' },
  { name: 'Kosovo', code: 883, iso: 'XK' },
  { name: 'Kuwait', code: 965, iso: 'KW' },
  { name: 'Kyrgyzstan', code: 996, iso: 'KG' },
  { name: 'Laos PDR', code: 856, iso: 'LA' },
  ...
  { name: 'Macau', code: 853, iso: 'MO', lang: 'zh_TW' },
  ...
  { name: 'Morocco/Western Sahara', code: 212, iso: 'MA' },
  ...
  { name: 'Palestinian Territory', code: 970, iso: 'PS' },
  ...
  { name: 'Reunion/Mayotte', code: 262, iso: 'RE' },
  { name: 'Romania', code: 40, iso: 'RO' },
  { name: 'Russia/Kazakhstan', code: 7, iso: 'RU' },
  ...
  { name: 'St Kitts and Nevis', code: 1869, iso: 'KN' },
  { name: 'St Lucia', code: 1758, iso: 'LC' },
  { name: 'St Pierre and Miquelon', code: 508, iso: 'PM' },
  { name: 'St Vincent Grenadines', code: 1784, iso: 'VC' },
  ...
  { name: 'Taiwan', code: 886, iso: 'TW', lang: 'zh_TW' },
  ...
  { name: 'Turkish Republic of Northern Cyprus', code: 90, iso: 'CY' },
