export default {
  messages: {
    ...
    zh_TW: {
      ...
      join_telegram_group_title: '加入電報或幣用群組',
      join_telegram_group_subtitle: '在部分國家可能需要 VPN 才能訪問電報群',
      verify_in_telegram_group_title: '在電報或幣用群組內驗證',
      verify_in_telegram_group_subtitle: '將您的驗證碼粘貼在電報或幣用群組內',
    ...
    zh_CN: {
      ...
      join_telegram_group_subtitle: '在部分国家可能需要 VPN 才能访问电报群',
